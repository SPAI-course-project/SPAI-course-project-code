...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/d/ffmpeg --target-os=win64 --arch=x86_64 --toolchain=msvc --enable-shared
prefix=/d/ffmpeg
...
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler Version 19.27.29112 for x86
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
CC=cl.exe
...
CFLAGS= -nologo    -Z7 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O2   -Oy- -utf-8
...
EXTRALIBS-avcodec=mfplat.lib mfuuid.lib ole32.lib strmiids.lib ole32.lib user32.lib
